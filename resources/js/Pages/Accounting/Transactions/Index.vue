  ...
  <AppLayout>
    <div class="p-6 space-y-6">
      <div class="flex justify-between items-center">
        ...
        <PrimaryModalButton @click="() => openModal()" label="Add Transaction">
        ...
        <table class="w-full text-sm text-left text-gray-600">
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-6 py-4">{{ account.sourceable?.name }}</td>
      ...
      <TransactionFormModal
        v-if="showModal"
        :transaction="editingTransaction" :banks="props.banks" :expenseTypes="props.expenseTypes" :incomeTypes="props.incomeTypes"
        @close="() => { showModal = false; editingTransaction = null }"
        @submitted="refresh"
      />
    </div>
  </AppLayout>
